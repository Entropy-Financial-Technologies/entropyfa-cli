...
For maintainer workflows, see [docs/data-pipeline.md](docs/data-pipeline.md). That doc covers the auto-apply path, the bounded auto-repair path for safe primer issues, and the manual review boundary for value disputes, missing official sources, and schema changes.
